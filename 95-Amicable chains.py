...
for i in range(2, 1_000_000):
	...
	n = i
	while True:
		# dict.setdefault always evaluates the alternate result if called even if it's not needed (which 
		# slows down the program significantly). Hence it is kept in the else loop 
